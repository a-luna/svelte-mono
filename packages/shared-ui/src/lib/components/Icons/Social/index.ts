...
import Github2 from '$lib/components/Icons/Social/Github2.svelte';
...
export { Codepen, Github, Github2, GithubSquare, LinkedIn, LinkedInSquare, Twitter, TwitterSquare, TwitterX };
