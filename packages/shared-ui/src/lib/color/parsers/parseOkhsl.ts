import { okhslToRgb } from '$lib/color/converters';
...
export const cssColorFromOkhsl = (okhsl: OkhslColor): CssColor =>
	finalizeRgbColor({ ...createCssColorBaseFromRgbColor(okhslToRgb(okhsl)), okhsl });
