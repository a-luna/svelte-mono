...
declare module '$env/static/private' {
	...
	export const npm_package_scripts_release_github: string;
	...
	export const PYTHONBREAKPOINT: string;
	...
	export const npm_package_devDependencies__a_luna_svelte_simple_tables: string;
	...
	export const npm_package_devDependencies__a_luna_shared_ui: string;
	export const npm_package_scripts_release_push: string;
	...
	export const npm_package_scripts_release_package: string;
	export const PATH: string;
	export const npm_config_argv: string;
	export const npm_package_scripts_commit: string;
	export const _: string;
	export const LaunchInstanceID: string;
	export const npm_package_scripts_release_npm: string;
	...
	export const npm_package_devDependencies_c8: string;
	...
	export const npm_package_devDependencies_svelte_icons: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_scripts_release_github: string;
		TERM_PROGRAM: string;
		...
		npm_package_devDependencies__a_luna_svelte_simple_tables: string;
		...
		npm_package_devDependencies__a_luna_shared_ui: string;
		npm_package_scripts_release_push: string;
		PAGER: string;
		...
		npm_package_scripts_release_package: string;
		PATH: string;
		npm_config_argv: string;
		npm_package_scripts_commit: string;
		_: string;
		LaunchInstanceID: string;
		npm_package_scripts_release_npm: string;
		...
		npm_package_devDependencies_c8: string;
		...
		npm_package_devDependencies_svelte_icons: string;
