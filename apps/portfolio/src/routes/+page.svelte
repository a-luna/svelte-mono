<script lang="ts">
	...
	// 	'oklch(59.69 15.6% 49.77deg / 50%)', // 59
	// 	'oklch(60 0.112 4.71239rad)', // 60
	// 	'oklch(60 28% 270deg)', // 61
	...
	// 	'#79eb0082',
	// 	'hsl(309 100% 46%)',
	// 	'hsl(5.39rad 100% 46% / 73%)',
	// 	'hsl(0.86turn 100% 46% / 0.73)',
	// 	'#01E1EC',
	// 	'rgb(47%, 92%, 0%)',
	// 	'rgb(0% 0% 27%)',
	// 	'rgb(238 0 204)',
	// 	'oklch(63.8% 0.280 337.72 / 0.73)',
	// 	'#876095',
	// 	'oklch(63.8% 0.280 337.72 / 0.73)',
	// ];
	...
	// 	console.log({
	// 		results: test.map((t) => ({
	// 			raw: ColorParser.parse(t).value,
	// 			clamped: clampColorComponents(ColorParser.parse(t).value),
	// 		})),
	// 	});
	// }
