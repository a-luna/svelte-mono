...
const cached = [
	{
		...
		stargazers_count: 0,
		forks_count: 1,
		html_url: 'https://github.com/a-luna/a-luna',
		stargazers_url: 'https://api.github.com/repos/a-luna/a-luna/stargazers',
		forks_url: 'https://api.github.com/repos/a-luna/a-luna/forks'
	},
	{
		name: 'aaronluna-common',
		description:
			'Utility classes and custom extension methods, this repository is used as a submodule in my other projects.',
		stargazers_count: 1,
		forks_count: 1,
		html_url: 'https://github.com/a-luna/aaronluna-common',
		stargazers_url: 'https://api.github.com/repos/a-luna/aaronluna-common/stargazers',
		forks_url: 'https://api.github.com/repos/a-luna/aaronluna-common/forks'
	},
	{
		name: 'aaronluna.dev',
