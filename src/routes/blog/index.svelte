...
<section
  class="mx-auto mb-16 mt-8 flex max-w-2xl flex-col items-start justify-center px-4 sm:px-8"
>
  <h1
  ...
  {#if !search}
    <h3
      class="mt-8 mb-4 text-2xl font-bold tracking-tight text-black dark:text-white md:text-4xl"
    >
      All Posts
    </h3>
  {/if}
  ...
  {:else if search}
    ...
    <button class="p-2 bg-slate-500" on:click={() => (search = "")}
