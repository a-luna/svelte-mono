...
export const categoryMetaData = {
  ...
  blog_portfolio_sites: {
    displayName: "Blog/Portfolio Sites",
    color: "green",
  },
  docs_guides: {
    displayName: "Docs/Guides",
    color: "green",
  },
  svelte_apps_sites: {
    displayName: "Svelte Apps",
    color: "pink",
  },
  svelte_components: {
...
export const getCategoryDetails = (name: FilterSetting): IconDetails =>
