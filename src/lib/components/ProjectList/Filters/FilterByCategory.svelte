<script lang="ts">
  ...
  import { BACKEND_CATEGORIES, FRONTEND_CATEGORIES } from "$lib/constants";
  import type { FilterSetting } from "$lib/types";

  export let filterCategory: FilterSetting = null;
  let expanded: boolean;
</script>

<div class="filty-by-category">
  <ProjectFilter
    id={"radio-category"}
  ...
  <ProjectFilter
    ...
    bind:expanded
    showIcons={false}
    filterSettings={[...BACKEND_CATEGORIES, ...FRONTEND_CATEGORIES]}
    startOptionNumber={3}
  />
</div>
