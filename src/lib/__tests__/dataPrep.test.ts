				...
				charMap: [
					{
						...
						bytes: [100],
						codepoints: ['U+64'],
						decimalCodepoints: [100],
						unicodeBlocks: ['Basic Latin'],
						unicodeNames: ['LATIN SMALL LETTER D'],
						totalBytes: 1,
						encoded: 'd',
					},
					{
						...
						bytes: [111],
						codepoints: ['U+6F'],
						decimalCodepoints: [111],
						unicodeBlocks: ['Basic Latin'],
						unicodeNames: ['LATIN SMALL LETTER O'],
						totalBytes: 1,
						encoded: 'o',
					},
					{
						...
						bytes: [103],
						codepoints: ['U+67'],
						decimalCodepoints: [103],
						unicodeBlocks: ['Basic Latin'],
						unicodeNames: ['LATIN SMALL LETTER G'],
						totalBytes: 1,
						encoded: 'g',
					},
				],
